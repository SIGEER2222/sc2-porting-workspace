...
- `static`: These are offline GLB preparation outcomes only. Neither candidate has been matched to the 44-bone Zergling rig, weighted, tested in Stand/Walk/Attack, exported to M3/M3A, or run in SC2; W4/W5 remain pending and W6 remains blocked.
