...
const MARKER_KINDS = new Set(["night_started","map_script_wave_spawned","special_infested_spawned","building_reinforcements_spawned","daytime_infected_cleared","build_completed","train_completed","infested_structure_destroyed"]);
