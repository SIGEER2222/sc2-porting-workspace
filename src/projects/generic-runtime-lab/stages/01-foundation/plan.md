...
5. Run static source tests, the VM probe, and the CMLib runtime self-test.
...
python src/lib/cmlib_runtime_test.py artifacts/projects/generic-runtime-lab/stage01-foundation/maps/RuntimeLab.SC2Map
```
