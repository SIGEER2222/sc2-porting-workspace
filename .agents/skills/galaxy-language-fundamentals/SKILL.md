...
A complete `BehaviorHandler.galaxy` module walkthrough plus struct/structref, funcref typedef,
library-function, and debug-helper examples live in
[references/naming-examples.md](references/naming-examples.md).
